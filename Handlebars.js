Handlebars.registerHelper("urlIs", function (r, e) {
  ...
  return -1 == l && (l = 999),
    ...
    Logger.log("Current url: " + Router.current().url.substring(0, l).replace("http://localhost:3000", "").replace("http://plenry.com", "")),
    Router.current().url.substring(0, l).replace("http://localhost:3000", "") === r;
});
