...
Template.mealShow.OnCreated(function () {
  Meteor.subscribe("oneUser", this.data.hostId),
    ...
    this.autorun(function () {
      Meteor.userId() && Meteor.subscribe("mealOrderCheck", this.data._id);
      var t = Orders.find({ mealId: this.data._id, status: { $gte: 0 } }), i = [];
  ...
  if (Session.set("mealId", e),
    ...
    var t = function() {
      var e = $(this).scrollTop(),
        t = $("#meal-cover-image").height(),
        i = 88,
        r = e + i,
        n = 0;
      $(".map-container").length > 0 &&
...
Template.mealShow.helpers({
  ...
  reserveOptions: function() {
    for (var e = [], t = 1; t <= this.spotsLeft; t++)
      e.push(1 == t ? { value: 1, text: "Only You" } : { value: t, text: "You + " + (t - 1) + " Guest(s)" });
    return e
  },
  isFull: function() {
