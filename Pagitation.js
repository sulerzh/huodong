var e = new Meteor.Pagination(Reviews,
{
  ...
  auth: function (e, t) {
    return [
      {
        $or: [
          { hostId: t.userId, userToHost: true },
...
var t = new Meteor.Pagination(Reviews,
{
  perPage: 5,
  sort: { createdAt: -1 },
  router: "iron-router",
  ...
  auth: function (e, t) {
    return [
      {
        $or: [
          { hostId: t.userId, userToHost: false },
...
var r = new Meteor.Pagination(Orders,
{
  perPage: 5,
  sort: { createdAt: -1 },
  router: "iron-router",
  ...
  auth: function (e, t) {
    ...
    [
      {
        status: 1,
        mealEndAt: { $lt: new Date, $gt: r },
        $or: [
          { userId: t.userId, guestReviewed: { $exists: false } },
...
var s = new Meteor.Pagination(Orders, {
  perPage: 10,
  sort: { createdAt: -1 },
  router: "iron-router",
...
var o = new Meteor.Pagination(Orders, {
  perPage: 10,
  sort: { createdAt: -1 },
  router: "iron-router",
  ...
  auth: function (e, t) {
    return [
      { hostId: t.userId, status: 1 },
      { skip: e, limit: 10, sort: { createdAt: -1 } }
    ];
  }
});

var i = new Meteor.Pagination(Orders, {
  perPage: 10,
  sort: { createdAt: -1 },
  router: "iron-router",
  routerTemplate: "receivedRequestCancelled",
  ...
  auth: function (e, t) {
    return [
      { hostId: t.userId, status: { $lte: -1 } },
      { skip: e, limit: 10, sort: { createdAt: -1 } }
    ];
  }
});

var a = new Meteor.Pagination(Meals, {
  perPage: 10,
  sort: { "time.startAt": 1 },
  router: "iron-router",
...
var u = new Meteor.Pagination(Meals,
{
  perPage: 10,
  sort: { "time.startAt": 1 },
  router: "iron-router",
...
var n = new Meteor.Pagination(Meals, {
  perPage: 20,
  sort: { "time.startAt": 1 },
  router: "iron-router",
  routerTemplate: "cancelledListing",
...
var m = new Meteor.Pagination(Orders, {
  perPage: 10,
  sort: { mealEndAt: -1 },
  router: "iron-router",
  ...
  homeRoute: "/users/me/reservations/upcoming",
  templateName: "upcomingReservation",
  divWrapper: false,
  auth: function(e, t) {
    return [
      { userId: t.userId, mealEndAt: { $gt: new Date } },
      { skip: e, limit: 10, sort: { mealEndAt: -1 } }
    ];
  }
});

var p = new Meteor.Pagination(Orders, {
  perPage: 10,
  sort: { mealEndAt: -1 },
  router: "iron-router",
  ...
  routerLayout: "DashboardReservationLayout",
  route: "/users/me/reservations/past",
  homeRoute: "/users/me/reservations/past",
  templateName: "pastReservation",
  divWrapper: false,
  auth: function(e, t) {
    return [
      { userId: t.userId, mealEndAt: { $lt: new Date } },
      { skip: e, limit: 10, sort: { mealEndAt: -1 } }
    ];
  }
});

var d = new Meteor.Pagination(Reviews, {
  perPage: 5,
  sort: { createdAt: -1 },
  router: "iron-router",
  routerTemplate: "userProfile",
  itemTemplate: "ReviewAboutYouItem",
  routerLayout: "AppLayout",
  route: "/users/:userId/reviews/guest",
  homeRoute: "/users/:userId/reviews/guest",
  templateName: "userProfile",
  availableSettings: { filters: true },
  routeSettings: function(e) {
    this.set("filters", { hostId: e.params.userId, userToHost: true });
  }
});

var l = new Meteor.Pagination(Reviews, {
  perPage: 5,
  sort: { createdAt: -1 },
  router: "iron-router",
  ...
  itemTemplate: "ReviewAboutYouItem",
  routerLayout: "AppLayout",
  route: "/users/:userId/reviews/host",
